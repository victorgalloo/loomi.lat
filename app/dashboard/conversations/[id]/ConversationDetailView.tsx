      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          <Link
            ...
            className="p-2 rounded-lg transition-colors hover:bg-surface-2 text-muted hover:text-foreground"
          >
        ...
        <div className="flex items-center gap-2">
          {botPaused && (
            <button
              ...
              disabled={resuming}
              className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium font-mono transition-colors duration-150 bg-terminal-green/10 text-terminal-green hover:bg-terminal-green/20 disabled:opacity-50"
            >
          ...
          <a
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors duration-150 bg-emerald-500/10 text-emerald-600 hover:bg-emerald-500/20"
          >
            ...
            <div className="px-4 py-3 border-t border-border">
              <div className="flex items-center gap-2">
                <input
                  ...
                  disabled={sending}
                  className="flex-1 px-4 py-2 rounded-lg text-sm font-mono outline-none transition-colors bg-background border border-border text-foreground placeholder:text-muted focus:border-foreground/30 disabled:opacity-50"
                />
                <button
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl p-5 bg-surface border border-border">
            ...
            <div className="space-y-2">
              <Link
                href={`/dashboard/crm`}
                className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm transition-colors w-full text-muted hover:text-foreground hover:bg-surface-2"
              >
