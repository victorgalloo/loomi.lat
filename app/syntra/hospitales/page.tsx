...
import { ArrowRight, Hospital, Heart, Activity, Users, AlertCircle, CheckCircle2, Stethoscope, Calendar } from "lucide-react";
...
export default function HospitalesPage() {
  const benefits = [
    {
      icon: Heart,
      title: "Mejora de Resultados de Pacientes",
      description: "Analiza patrones de tratamiento, tiempos de recuperación y tasas de éxito por diagnóstico. Identifica las mejores prácticas clínicas y optimiza protocolos de atención.",
    },
    {
      icon: Activity,
      title: "Gestión de Recursos Hospitalarios",
      description: "Optimiza el uso de camas, quirófanos, equipos médicos y personal. Prevén desabastos de medicamentos y materiales críticos con predicciones basadas en demanda histórica.",
    },
    {
      icon: Users,
      title: "Análisis de Flujo de Pacientes",
      description: "Entiende patrones de admisión, tiempos de espera y congestión en urgencias. Optimiza la asignación de recursos para reducir tiempos de atención y mejorar la experiencia del paciente.",
    },
    {
      icon: Stethoscope,
      title: "Control de Infecciones y Seguridad",
      description: "Detecta patrones de infecciones nosocomiales, complicaciones post-operatorias y eventos adversos. Prevén problemas antes de que se conviertan en brotes.",
    },
  ];
  ...
  const decisions = [
    {
      ...
      description: "Identifica factores de riesgo y patrones que preceden complicaciones. Intervén proactivamente para prevenir eventos adversos y mejorar seguridad del paciente.",
    },
    {
      icon: CheckCircle2,
      title: "Optimización de Listas de Espera",
      description: "Gestiona eficientemente las listas de espera quirúrgicas y de especialidades. Prioriza casos basándote en urgencia clínica y recursos disponibles.",
    },
    {
      icon: CheckCircle2,
      title: "Gestión de Personal y Turnos",
      description: "Optimiza la asignación de personal médico y de enfermería según demanda esperada, experiencia y especialización. Asegura cobertura adecuada en momentos críticos.",
    },
    {
      icon: CheckCircle2,
      title: "Control de Costos y Eficiencia",
      description: "Analiza costos por procedimiento, estancia y diagnóstico. Identifica oportunidades de optimización sin comprometer la calidad de atención.",
    },
  ];

  const exampleQueries = [
    "¿Cuáles son las especialidades con mayor tiempo de espera promedio?",
    "Compara las tasas de infección nosocomial entre departamentos este año",
    "Muestra los diagnósticos con mayor tasa de reingreso en los últimos 6 meses",
    "¿Cuáles son los procedimientos más costosos por especialidad?",
    "Identifica patrones de uso de quirófanos por día de la semana y hora",
    "Analiza la relación entre tiempo de espera en urgencias y satisfacción del paciente",
  ];
    ...
    <main className="relative z-10 flex min-h-screen flex-col" style={{ background: "linear-gradient(135deg, #e8eaf6 0%, #f5f5f5 50%, #e3f2fd 100%)", transform: "translateZ(0)", willChange: "transform", backfaceVisibility: "hidden" }}>
      <header className="flex w-full items-center justify-between px-8 py-6 md:px-16">
        <div className="flex items-end gap-3">
          <Link href="/syntra">
            <img src="/assets/icons/Syntra hor no bg lightmode.svg" alt="Syntra" className="h-10 w-auto cursor-pointer" />
          </Link>
          <div className="mb-0.5 flex items-center gap-1.5">
            <span className="text-[9px] font-medium text-muted-foreground">powered by</span>
            <img src="/assets/icons/databricks1.svg" alt="Databricks" className="h-2.5 w-auto" />
          </div>
        </div>
        <Link href="/syntra">
          <Button variant="outline" size="sm" className="rounded-full border-black/10">Volver</Button>
        </Link>
      </header>
      ...
      <section className="flex flex-1 flex-col items-center justify-center px-8 py-20 text-center md:px-16">
        <div className="mx-auto max-w-4xl space-y-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="flex justify-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-rose-50 to-rose-100">
          ...
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }} className="text-5xl font-bold leading-tight tracking-tight text-base-foreground md:text-6xl lg:text-7xl">
            ...
            <span className="bg-gradient-to-r from-primary via-[#FF9E62] to-[#AA2801] bg-clip-text text-transparent">
              Mejora resultados de pacientes con análisis poderosos
            </span>
          </motion.h1>
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="mx-auto max-w-2xl text-lg leading-relaxed text-muted-foreground md:text-xl">
            Transforma los datos clínicos, operativos y administrativos en decisiones que mejoran los resultados de los pacientes y optimizan la eficiencia hospitalaria.
          </motion.p>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} className="flex flex-col items-center gap-4 pt-4">
            <Link href="/#contact">
              <Button size="lg" className="group h-14 rounded-full bg-primary px-8 text-base font-semibold text-white shadow-[0_8px_24px_rgba(255,159,50,0.3)] transition-all hover:shadow-[0_12px_32px_rgba(255,159,50,0.4)] hover:bg-primary/90">
                Solicitar Demo
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-12 md:grid-cols-2 md:items-center">
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="text-3xl font-bold text-base-foreground md:text-4xl lg:text-5xl">El Desafío de la Atención Hospitalaria Moderna</h2>
              <p className="text-lg leading-relaxed text-muted-foreground md:text-xl">
                Los hospitales y clínicas gestionan información crítica sobre pacientes, tratamientos, recursos y operaciones. Convertir estos datos en decisiones que mejoren los resultados de los pacientes requiere acceso inmediato a insights clínicos y operativos.
              </p>
              <p className="text-lg leading-relaxed text-muted-foreground md:text-xl">
                Syntra permite que tu equipo pregunte directamente sobre atención al paciente, operaciones y recursos, recibiendo respuestas instantáneas que permiten tomar decisiones informadas basadas en datos reales.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
      ...
      <section className="border-t border-black/5 bg-gradient-to-b from-white to-base px-8 py-20 md:px-16">
        <div className="mx-auto max-w-7xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-16 text-center">
            <h2 className="text-4xl font-bold text-base-foreground md:text-5xl lg:text-6xl">Qué te brinda Syntra para Hospitales</h2>
          </motion.div>
          <motion.div
          ...
          >
            <img
              ...
              alt="Análisis médico y datos de salud"
            ...
            {benefits.map((benefit, index) => {
              ...
              return (
                <motion.div key={benefit.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: index * 0.1 }} className="group relative overflow-hidden rounded-3xl bg-white p-8 shadow-xl transition-all hover:shadow-2xl">
                  <div className="absolute inset-0 bg-gradient-to-br from-rose-50/50 via-transparent to-transparent opacity-0 transition-opacity group-hover:opacity-100" />
                  <div className="relative space-y-4">
                    <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-rose-50 to-rose-100">
                      <IconComponent className="h-7 w-7 text-rose-600" />
                    </div>
          ...
          <div className="grid gap-12 md:grid-cols-2 md:items-center mb-16">
            ...
            >
              <img
                ...
                alt="Decisión médica basada en datos"
                className="h-full w-full object-cover"
              />
            </motion.div>
            <motion.div
      ...
      <section className="border-t border-black/5 px-8 py-20 md:px-16">
        <div className="liquid-glass-gradient ambient-glow mx-auto max-w-4xl rounded-[40px] border border-white/40 p-12 text-center md:p-16" style={{ transform: "translateZ(0)", willChange: "transform", backfaceVisibility: "hidden" }}>
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="space-y-8">
            <h2 className="text-3xl font-bold text-base-foreground md:text-4xl lg:text-5xl">¿Listo para mejorar los resultados de tus pacientes?</h2>
            <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              ...
              <Link href="/syntra">
                <Button size="lg" variant="outline" className="h-14 rounded-full border-black/10 px-8 text-base font-semibold">
      ...
      <footer className="border-t border-black/5 px-8 py-8 text-center">
        <p className="text-sm text-muted-foreground">© 2024 Syntra. Powered by Databricks. All rights reserved.</p>
      </footer>
    </main>
  );
}
