      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {botPaused && (
              <span className={`px-2 py-0.5 rounded-full text-xs font-medium font-mono ${
        ...
        <div className="flex items-center gap-2">
          {botPaused && (
            <button
              ...
              disabled={resuming}
              className={`
                flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium font-mono
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <div className={`rounded-xl overflow-hidden ${isDarkMode ? 'bg-zinc-900 border border-zinc-800' : 'bg-white border border-zinc-200'}`}>
            <div className={`px-5 py-4 border-b flex items-center justify-between ${isDarkMode ? 'border-zinc-800' : 'border-zinc-200'}`}>
              ...
              {botPaused && (
                <div className="flex items-center gap-1.5">
                  <PauseCircle className={`w-3.5 h-3.5 ${isDarkMode ? 'text-amber-400' : 'text-amber-600'}`} />
            ...
            <div className={`p-4 h-[400px] overflow-y-auto space-y-3 ${isDarkMode ? 'bg-zinc-950/50' : 'bg-zinc-50'}`}>
            ...
            {/* Reply Input */}
            <div className={`px-4 py-3 border-t ${isDarkMode ? 'border-zinc-800' : 'border-zinc-200'}`}>
              <div className="flex items-center gap-2">
                <input
                  type="text"
                  value={replyText}
                  ...
                  disabled={sending}
                  className={`
                    flex-1 px-4 py-2 rounded-lg text-sm font-mono outline-none transition-colors
                    ${isDarkMode
                      ? 'bg-zinc-950 border border-zinc-700 text-white placeholder:text-zinc-600 focus:border-zinc-500'
                ...
                <button
                  ...
                  className={`
                    p-2 rounded-lg transition-colors
                    ${isDarkMode
                      ? 'bg-foreground text-background hover:bg-zinc-200 disabled:bg-zinc-800 disabled:text-zinc-600'
                      : 'bg-zinc-900 text-white hover:bg-zinc-700 disabled:bg-zinc-200 disabled:text-zinc-400'
                    }
              ...
              <p className={`text-xs mt-1.5 font-mono ${isDarkMode ? 'text-zinc-600' : 'text-zinc-400'}`}>
                {botPaused
